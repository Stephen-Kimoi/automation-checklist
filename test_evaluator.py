...
def test_single_project():
    ...
    try:
        ...
        print(f"README Installation Score: {result['readme_installation_score']}/5")
        print(f"README Quality Score: {result['readme_quality_score']}/5")
        print(f"Commit Activity Score: {result['commit_activity_score']}/5")
